...
export function LogoutIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      />
      <path
        d="M17 8.5 20.5 12 17 15.5M10.5 12h10"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function CameraIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        d="M4 8.5h2.6l1.3-2h8.2l1.3 2H20a1 1 0 0 1 1 1V19a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.5a1 1 0 0 1 1-1Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function UploadIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      />
      <path
        d="M4 15v3.5a1.5 1.5 0 0 0 1.5 1.5h13a1.5 1.5 0 0 0 1.5-1.5V15"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M8 4v5h7V4.5" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <rect x="8" y="13" width="8" height="5" rx="1" stroke="currentColor" strokeWidth="1.6" />
    </svg>
  );
}
...
export function ShieldIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        d="M12 3.2 5 6v5.4c0 4.2 2.9 7.5 7 9.4 4.1-1.9 7-5.2 7-9.4V6l-7-2.8Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function EyeOffIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        d="M6.5 6.9C4.2 8.5 2.5 12 2.5 12S6 18.5 12 18.5c1.7 0 3.2-.5 4.5-1.2M9.9 5.8c.7-.2 1.4-.3 2.1-.3 6 0 9.5 6.5 9.5 6.5s-1 1.9-2.8 3.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M10 10a3 3 0 0 0 4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
...
export function ChartIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path
        d="M6.5 17.5v-5M11 17.5V6.5M15.5 17.5v-8M20 17.5v-3"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function GearIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path
        d="M12 3.2l1.5 1.9 2.4-.5.6 2.4 2.2 1.1-1 2.2 1 2.2-2.2 1.1-.6 2.4-2.4-.5L12 20.8l-1.5-1.9-2.4.5-.6-2.4-2.2-1.1 1-2.2-1-2.2 2.2-1.1.6-2.4 2.4.5L12 3.2Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
export function HomeIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        d="M4 10.5 12 4l8 6.5V19a1 1 0 0 1-1 1h-4v-5.5H9V20H5a1 1 0 0 1-1-1v-8.5Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function FolderIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        d="M3.5 7.5A1.5 1.5 0 0 1 5 6h3.6l1.6 2H19a1.5 1.5 0 0 1 1.5 1.5V17A1.5 1.5 0 0 1 19 18.5H5A1.5 1.5 0 0 1 3.5 17V7.5Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function PlusCircleIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M12 8.6v6.8M8.6 12h6.8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export function FlagIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M6 3.5V20.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path
        d="M6 4.6h9.8l-1.6 3.4 1.6 3.4H6V4.6Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function HourglassIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M7 3.5h10M7 20.5h10" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path
        d="M8 3.5v3.2c0 1 .4 1.9 1.1 2.5L12 12l-2.9 2.8c-.7.6-1.1 1.5-1.1 2.5v3.2M16 3.5v3.2c0 1-.4 1.9-1.1 2.5L12 12l2.9 2.8c.7.6 1.1 1.5 1.1 2.5v3.2"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function FileQuestionIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M13.2 3.6V8H18" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <path
        d="M10.4 12.4c0-.9.7-1.6 1.7-1.6s1.7.7 1.7 1.6c0 .8-.5 1.1-1.1 1.5-.4.3-.6.6-.6 1.1"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <circle cx="12.1" cy="17.4" r="0.85" fill="currentColor" />
    </svg>
  );
}
